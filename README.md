...
- `./scripts/status`: summarizes whether the system is active, planned, blocked, or cleanly idle-blocked, shows current work, planned work, human blockers, review-gated work, dependency-waiting work, and flags stale work
